      ...
      {(nutris) ?
        ...
        <Form.Row>
          ...
          <Form.Group as={Col} controlId="formGridNutricionista">
            <Form.Label>Seleccione el nutricionista de su preferencia </Form.Label>
          ...
          <>
            ...
            <Form.Row>
              <Form.Group as={Col} controlId="formGridCintura">
                ...
                <Form.Control type="number" placeholder="Cintura" onChange={e => setCintura(e.target.value)} />
              </Form.Group>
              <Form.Group as={Col} controlId="formGridPantorrilla">
                <Form.Label> Pantorrilla (cm)</Form.Label>
                <Form.Control type="number" placeholder="Pantorrilla" onChange={e => setPantorrilla(e.target.value)} />
              </Form.Group>
              <Form.Group as={Col} controlId="formGridBrazo">
                <Form.Label> Brazo (cm)</Form.Label>
                <Form.Control type="number" placeholder="Brazo" onChange={e => setBrazo(e.target.value)} />
              </Form.Group>
            ...
            <Form.Row>
              <Form.Group as={Col} controlId="formGridPeso">
                ...
                <Form.Control type="number" placeholder="Peso" onChange={e => setPeso(e.target.value)} />
              </Form.Group>
              <Form.Group as={Col} controlId="formGridEstatura">
                <Form.Label>Estatura (m)</Form.Label>
                <Form.Control type="number" placeholder="Estatura" onChange={e => setEstatura(e.target.value)} />
              </Form.Group>
